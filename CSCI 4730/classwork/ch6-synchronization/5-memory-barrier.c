...
void lock(int self) {
    ...
    asm volatile ("mfence"); // memory barrier to ensure ordering of operations is maintained
...
* Memory Barrier added to ensure proper ordering of operations in the lock function.
*/
int main() {
